...
\code{NETCDF4_ROOT_32}, \code{NETCDF4_ROOT_64}, and \code{NETCDFR_ROOT}
...
and \code{pbdNCDF4/R/windows/zzz.R} will be compiled, too.
At run time, \code{.onLoad()} of \code{pbdNCDF4/R/windows/zzz.R} will
